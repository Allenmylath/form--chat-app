    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-8 relative">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Interactive Form & Chat</h1>
            <p className="text-muted-foreground">Complete the form and chat with our assistant</p>
          </div>
        </header>
